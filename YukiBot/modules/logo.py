...
from YukiBot.modules.nightmode import button_row
from YukiBot import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./YukiBot/resources/fonts/*")
        ...
        await telethn.send_file(
            event.chat_id,
            file=fname,
            caption=f"""sᴜᴄᴄᴇsғᴜʟʟʏ ᴄʀᴇᴀᴛᴇᴅ"""buttons=button_row
)
        await pesan.delete()
