...
import YukiBot
import YukiBot.modules.sql.welcome_sql as sql
from YukiBot import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from YukiBot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from YukiBot.modules.helper_funcs.msg_types import get_welcome_type
from YukiBot.modules.helper_funcs.string_handling import (
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Oʜ ɢᴇɴᴏs, ᴛʜᴇ ᴏᴡɴᴇʀ ᴏғ         「 𝙿ᴀʀᴀᴅᴏx ˣ 」  ʜᴀs ᴊᴜsᴛ ᴊᴏɪɴᴇᴅ !!.", reply_to_message_id=reply
                )
                welcome_log = (
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Bᴇ ᴄᴏᴏʟ! A ᴍᴇᴍʙᴇʀ ᴏғ ᴛʜᴇ ᴘᴀʀᴀᴅᴏx ʜᴀs Jᴜsᴛ Jᴏɪɴᴇᴅ.",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
