...
import YukiBot.modules.sql.global_bans_sql as sql
from YukiBot import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from YukiBot.modules.helper_funcs.misc import send_to_list
from YukiBot.modules.sql.users_sql import get_user_com_chats
