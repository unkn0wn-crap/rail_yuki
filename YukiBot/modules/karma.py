...
from YukiBot import OWNER_ID, pbot
from YukiBot.utils.admins import can_change_info
from YukiBot.utils.errors import capture_err
from YukiBot.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote =r"^(\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤️|💘|cool|good|\👍|thank you|gud|thankyou|love|pro)$"
