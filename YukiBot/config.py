...
class Config(object):
    ...
    ANILIST_SECRET = os.getenv("ANILIST_SECRET",
                               "NeCEq9A1hVnjsjZlTZyNvqK11krQ4HtSliaM7rTN")
    ...
    TOKEN = os.getenv("TOKEN",
                      "5527818445:AAE7TLprBfyUuQvYZsaOesQ0F-9C2sl2I80")

    OWNER_ID = os.getenv("OWNER_ID", "6810396528")

    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "weedlized")
    ...
    MONGO_DB_URI = os.getenv(
        "MONGO_DB_URI",
        "mongodb+srv://arnavgupta0078:arnav@cluster3301.ojyvd.mongodb.net/?retryWrites=true&w=majority"
    )

    LOG_CHANNEL = os.getenv("LOG_CHANNEL", "-1002221570986")

    BOT_USERNAME = os.getenv("BOT_USERNAME", "deds3c_bot")

    DATABASE_URL = os.getenv(
        "DATABASE_URL",
        "postgresql://postgres:WUcp0oe6jS5DtnUY@tastelessly-delicate-moccasin.data-1.use1.tembo.io:5432/postgres"
    )
    ...
    SPAMWATCH_API = os.getenv(
        "SPAMWATCH_API",
        "3624487efd8e4ca9c949f1ab99654ad1e4de854f41a14afd00f3ca82d808dc8c")
    ...
    OPENWEATHERMAP_ID = os.getenv("OPENWEATHERMAP_ID",
                                  "887da2c60d9f13fe78b0f9d0c5cbaade")

    BAN_STICKER = os.getenv(
        "BAN_STICKER",
        "CAACAgUAAxkBAAJW8WZDBQe8YG5vZWXx9E2ILluzxMKsAAJZDQACluSpVdFgrIHsInutNQQ"
    )
    ...
    DRAGONS = [6331067820, 5053815620, 6693143450, 5466213869]  # User id of sudo users
    DEV_USERS = [6259443940]  # User id of dev users
